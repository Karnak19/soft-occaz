...
export type ListingsResponse<Timages = unknown, Texpand = unknown> = Required<ListingsRecord<Timages>> &
...
export type ReferralTiersResponse<Ttier = unknown, Texpand = unknown> = Required<ReferralTiersRecord<Ttier>> &
  BaseSystemFields<Texpand>;
export type ReportsResponse<Texpand = unknown> = Required<ReportsRecord> & BaseSystemFields<Texpand>;
export type SearchResponse<Treference_images = unknown, Texpand = unknown> = Required<SearchRecord<Treference_images>> &
  BaseSystemFields<Texpand>;
export type StatsResponse<Tlistings_count = unknown, Tusers_count = unknown, Texpand = unknown> = Required<
  StatsRecord<Tlistings_count, Tusers_count>
> &
  BaseSystemFields<Texpand>;
export type UnreadMessagesResponse<TunreadCount = unknown, Texpand = unknown> = Required<UnreadMessagesRecord<TunreadCount>> &
  BaseSystemFields<Texpand>;
...
export type UsersAverageRatingResponse<Taverage_rating = unknown, Texpand = unknown> = Required<
  UsersAverageRatingRecord<Taverage_rating>
> &
  BaseSystemFields<Texpand>;
