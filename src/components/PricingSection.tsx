...
const tiers = [
  {
    ...
    description: '',
    features: ['50 annonces', '3 photos par annonce'],
    mostPopular: false,
    cta: "S'inscrire",
  },
  {
    ...
    description: '',
    features: ['100 annonces', '5 photos par annonce', 'Import automatique depuis Airsoft-occasion'],
    mostPopular: false,
    cta: "S'abonner",
  },
  {
    ...
    description: '',
    features: ['100 annonces', '5 photos par annonce', 'Import automatique depuis Airsoft-occasion', 'Annonces stylisées'],
    mostPopular: false,
    cta: "S'abonner",
  },
  {
