...
function SearchSection() {
  return (
    <div className="relative grid py-40 place-items-center">
      <Image src={banner} alt="banner" className="absolute inset-0 object-cover object-top w-full h-full opacity-25" />

      <div className="w-full max-w-3xl p-16 rounded-lg shadow-lg bg-slate-800/60 backdrop-blur-md">
