...
const values: Value[] = [
  ...
  },
  {
    ...
    description:
      'Chaque utilisateur est vérifié, chaque transaction est sécurisée. Nous mettons tout en œuvre pour créer un environnement de confiance.',
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="relative">
            <Image
              ...
              className="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-muted/10 sm:w-[57rem] md:-ml-4 lg:-ml-0"
              width={2432}
              height={1442}
            />
            <div className="absolute inset-0 rounded-xl bg-gradient-to-tr from-primary/20 to-transparent opacity-40" />
          </div>
        </div>
      </div>
    </div>
