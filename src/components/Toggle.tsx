    ...
    <Switch.Group as="div" className="flex flex-row items-center justify-between lg:gap-4 lg:justify-center lg:flex-col">
      ...
      <Switch
        ...
        className={cn(
          ...
          'relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rg-500 ',
        )}
      >
        ...
        >
          <span
            ...
            aria-hidden="true"
          >
            <svg className="w-3 h-3 text-rg-300" fill="none" viewBox="0 0 12 12">
              <path
          ...
          <span
            ...
            aria-hidden="true"
          >
            <svg className="w-3 h-3 text-rg-500 " fill="currentColor" viewBox="0 0 12 12">
