...
export default function Toggle({ value, onChange }: ControllerRenderProps<FormData, 'envoi'>) {
  return (
    <Switch.Group as="div" className="flex flex-row items-center justify-between lg:flex-col lg:justify-center lg:gap-4">
      <span className="flex flex-grow flex-col lg:flex-grow-0">
      ...
      <Switch
        ...
        className={cn(
          ...
          'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-rg focus:ring-offset-2',
        )}
      >
        ...
        >
          <span
            ...
            aria-hidden="true"
          >
            <svg className="h-3 w-3 text-rg-light" fill="none" viewBox="0 0 12 12">
              <path
          ...
          <span
            ...
            aria-hidden="true"
          >
            <svg className="h-3 w-3 text-rg" fill="currentColor" viewBox="0 0 12 12">
