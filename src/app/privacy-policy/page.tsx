  ...
  return (
    <div className="prose prose-sm prose-invert mx-auto max-w-[100ch]">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Airsoft Market.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Airsoft Market, accessible from{' '}
      ...
      <p>
        ...
        or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more
      ...
      <ul>
        <li>By email: basile64.v@gmail.com</li>
      </ul>
    </div>
  );
}
